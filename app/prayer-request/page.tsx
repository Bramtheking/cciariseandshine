            ...
            <CardContent className="p-8">
              ...
              <form className="space-y-6">
                ...
                <div>
                  ...
                  <select className="w-full px-4 py-3 rounded-2xl border border-purple-200 focus:ring-2 focus:ring-purple-300 focus:border-transparent outline-none bg-white/50">
                ...
                <Button className="w-full bg-purple-600 hover:bg-purple-700 text-white py-4 rounded-2xl text-lg font-medium">
