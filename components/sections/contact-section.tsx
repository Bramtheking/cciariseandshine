      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8 mb-16">
          {[
            ...
            },
            {
              icon: Mail,
              title: "Email",
              content: ["info@ariseshinecci.org"],
          ...
          ].map(({ icon: Icon, title, content, gradient, delay }) => (
            <Card
              key={title}
              className={`bg-white/90 backdrop-blur-xl border-white/60 rounded-3xl shadow-xl hover:shadow-2xl transform hover:-translate-y-4 hover:rotate-2 transition-all duration-500 animate-fade-in-up animation-delay-${delay} group overflow-hidden`}
            >
        ...
        <div className="grid lg:grid-cols-2 gap-12 mb-16">
            ...
            <CardContent className="p-10 relative">
              ...
              <form className="space-y-6">
                ...
                <div>
                  ...
                  <select className="w-full px-4 py-3 rounded-2xl border-2 border-gray-200 focus:ring-2 focus:ring-purple-300 focus:border-transparent outline-none bg-white/80 backdrop-blur-sm transition-all duration-300">
                ...
                <Button className="w-full bg-gradient-to-r from-purple-600 to-pink-600 hover:from-purple-700 hover:to-pink-700 text-white py-4 rounded-2xl text-lg font-bold shadow-lg hover:shadow-xl transform hover:-translate-y-1 transition-all duration-300">
          ...
          <div className="space-y-8">
              ...
              <CardContent className="p-8 relative">
                ...
                <div className="space-y-4">
                  {[
                    ...
                    { service: "Wednesday Prayer", time: "6:00 PM - 8:00 PM", desc: "Prayer and Bible study" },
                    { service: "Friday Fellowship", time: "7:00 PM - 9:00 PM", desc: "Youth and family time" },
                  ].map((item, i) => (
            ...
            {/* Map Section */}
            <Card className="bg-white/90 backdrop-blur-xl border-white/60 rounded-3xl shadow-xl hover:shadow-2xl transition-all duration-500 animate-fade-in-right animation-delay-200 group overflow-hidden">
