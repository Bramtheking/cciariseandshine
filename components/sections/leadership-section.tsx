    ...
    <section className="py-24 px-4 relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        <div className="grid md:grid-cols-3 gap-10">
          ...
          ].map(({ name, role, description, icon: Icon, gradient, delay }) => (
            <Card
              key={name}
              className={`bg-white/90 backdrop-blur-xl border-white/60 rounded-3xl shadow-2xl hover:shadow-4xl transform hover:-translate-y-8 hover:rotate-2 transition-all duration-700 animate-fade-in-up animation-delay-${delay} group overflow-hidden`}
            >
              <CardContent className="p-10 text-center relative">
                ...
                <div className="flex justify-center space-x-2 mt-6">
                  ...
                  <div className={`w-2 h-2 bg-gradient-to-r ${gradient} rounded-full opacity-60`}></div>
                  <div className={`w-2 h-2 bg-gradient-to-r ${gradient} rounded-full opacity-30`}></div>
                </div>
              </CardContent>
            </Card>
          ))}
